# Android GUI for [WireGuard](https://www.wireguard.com/) (fork)
...
## WSTunnel integration (fork)

This fork adds optional WSTunnel support. The embedded binary shipped in `jniLibs` is **WSTunnel v10.5.2**.
